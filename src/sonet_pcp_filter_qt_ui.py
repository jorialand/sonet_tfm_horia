...
#
# Created: Tue Dec 22 23:00:19 2020
...
class Ui_sonet_pcp_filter(object):
    def setupUi(self, sonet_pcp_filter):
        ...
        sonet_pcp_filter.resize(527, 552)
        ...
        self.radio_mission = QtWidgets.QRadioButton(self.top_left_group_box)
        self.radio_mission.setEnabled(False)
        self.radio_mission.setObjectName("radio_mission")
        self.horizontalLayout_10.addWidget(self.radio_mission)
        self.radio_spacecraft = QtWidgets.QRadioButton(self.top_left_group_box)
        self.radio_spacecraft.setEnabled(False)
        self.radio_spacecraft.setObjectName("radio_spacecraft")
        ...
        self.combo_event = QtWidgets.QComboBox(self.top_left_group_box)
    ...
    def retranslateUi(self, sonet_pcp_filter):
        ...
        self.radio_mission.setText(QtWidgets.QApplication.translate("sonet_pcp_filter", "Mission", None, -1))
        self.radio_spacecraft.setText(QtWidgets.QApplication.translate("sonet_pcp_filter", "S/C", None, -1))
        self.combo_event.setItemText(0, QtWidgets.QApplication.translate("sonet_pcp_filter", "Select event", None, -1))
