...
class Ui_sonet_pcp_filter(object):
    def setupUi(self, sonet_pcp_filter):
        ...
        sizePolicy1.setHeightForWidth(self.applied_filters_table_view.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy3.setHeightForWidth(self.combo_energy_operator.sizePolicy().hasHeightForWidth())
        self.combo_energy_operator.setSizePolicy(sizePolicy3)
        ...
        sizePolicy5.setHeightForWidth(self.combo_dept_arriv.sizePolicy().hasHeightForWidth())
        self.combo_dept_arriv.setSizePolicy(sizePolicy5)
        ...
        sizePolicy3.setHeightForWidth(self.combo_planet.sizePolicy().hasHeightForWidth())
        self.combo_planet.setSizePolicy(sizePolicy3)
        ...
        sizePolicy5.setHeightForWidth(self.spin_number.sizePolicy().hasHeightForWidth())
        self.spin_number.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.combo_select_spacecraft.sizePolicy().hasHeightForWidth())
        self.combo_select_spacecraft.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.combo_when_2.sizePolicy().hasHeightForWidth())
        self.combo_when_2.setSizePolicy(sizePolicy5)
