...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.page_mission.setGeometry(QRect(0, 0, 230, 352))
        ...
        self.page_spacecraft.setGeometry(QRect(0, 0, 230, 352))
        ...
        self.page_commands.setGeometry(QRect(0, 0, 230, 352))
        ...
        self.page_others.setGeometry(QRect(0, 0, 230, 352))
