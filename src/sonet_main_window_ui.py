...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.page_mission.setGeometry(QRect(0, 0, 230, 235))
        ...
        self.page_spacecraft.setGeometry(QRect(0, 0, 230, 235))
        ...
        self.page_commands.setGeometry(QRect(0, 0, 230, 235))
        ...
        self.page_others.setGeometry(QRect(0, 0, 230, 235))
    ...
    def retranslateUi(self, main_window):
        main_window.setWindowTitle(QCoreApplication.translate("main_window", u"SONet Mars Mission Planner", None))
        ...
        self.sonet_mission_tree_qgb.setTitle(QCoreApplication.translate("main_window", u"S/C", None))
